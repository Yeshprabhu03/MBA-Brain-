...
1. Supply chain is the hidden competitive advantage in retail — customers see low prices; they don't see the distribution network that enables them
2. Cross-docking eliminates warehousing costs — products go from inbound truck to outbound truck in <24 hours
...
4. First-mover advantage in infrastructure creates compounding returns — each year of earlier investment widens the cost gap
