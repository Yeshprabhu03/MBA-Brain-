...
1. Build-to-order eliminates finished goods inventory risk — Dell never builds PCs nobody wants
2. Negative working capital (customer pays → Dell pays suppliers 30+ days later) is a cash flow advantage that grows with scale
3. Direct-to-customer eliminates retail margins and provides demand data that improves forecasting
4. BTO advantages erode when products become commoditized — Dell eventually added retail (2007) as differentiation declined
...
- [[Supply Chain Management]], [[Lean Manufacturing]], [[Cash Flow Statement]], [[Competitive Advantage]]
