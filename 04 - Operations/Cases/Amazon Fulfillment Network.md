...
Amazon built the world's largest fulfillment network: 1,000+ facilities, 1.5M workers, $60B+ invested. Its one-day/same-day Prime delivery promise requires inventory positioned within hours of every major population center. Amazon's operations are the primary competitive moat — not the website.
...
2. Massive fixed-cost infrastructure creates barriers to entry — no competitor can replicate Amazon's $60B+ fulfillment investment
...
- [[Supply Chain Management]], [[Lean Manufacturing]], [[Competitive Advantage]], [[Porter's Five Forces]]
