...
How can a fashion company reduce forecasting risk when products must be committed months before demand is known? Sport Obermeyer uses a 'committee consensus + mathematical modeling' approach to production planning under uncertainty.
...
- [[Supply Chain Management]], [[Monte Carlo Simulation]], [[Lean Manufacturing]], [[Regression Analysis]]
