...
Does Airbnb create economic value or extract it from local communities? The case examines externalities — costs imposed on third parties (long-term renters) by transactions between hosts and guests.

---

## 📊 Analysis

Economic analysis: Airbnb creates value for hosts (income) and tourists (cheaper accommodation) but imposes costs on neighbors (noise, turnover) and local renters (supply reduction → higher rents). This is a textbook negative externality — the market price doesn't include the social cost. Pigouvian solution: tax short-term rentals to internalize the externality (many cities now do this). Quantity solution: cap nights per year (Amsterdam's 30-night limit).

---

## 🔑 Key Lessons

1. Platform businesses can create negative externalities — costs borne by non-participants (local renters)
2. Housing supply is inelastic in the short run — converting units from long-term to short-term reduces local supply
3. Regulatory responses (caps, taxes, registration) are Pigouvian corrections for market externalities
4. Platform effects concentrate in specific neighborhoods — city-wide data can mask neighborhood-level housing market distortion
...
- [[Supply and Demand]], [[Behavioral Economics Overview]], [[Pricing Strategies]], [[Stakeholder Theory]]
