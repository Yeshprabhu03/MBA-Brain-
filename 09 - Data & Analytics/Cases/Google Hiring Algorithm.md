...
1. Intuition is a poor predictor of job performance; structured data is superior
2. Standardizing the interview process is the only way to remove 'unconscious bias'
3. GPA and prestige are 'lazy proxies' that data often debunks
4. Optimization doesn't just mean 'better'—it means 'faster' (e.g., stopping at four interviews)

---

## 🎓 Discussion Questions

1. If GPA doesn't matter, why does Google still attract mostly elite school grads?
2. How do you scale 'structured interviews' in a rapidly growing company?
3. What are the limits of 'People Analytics' when hiring for high-creativity roles?
