...
1. **Divisional WACCs are essential for multi-business companies** — otherwise capital flows to highest-risk divisions
2. The choice of risk-free rate (T-bill vs. T-bond) significantly impacts cost of equity calculations
3. **Pure-play comparables are imperfect** — judgment is required in selecting and weighting proxy companies
...
3. What happens if Midland uses a single WACC — which division benefits and which is penalized?
