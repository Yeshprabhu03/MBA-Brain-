---
title: LBO Model
tags: [finance, private-equity, valuation, concept]
aliases: [Leveraged Buyout, buyout model, PE model]
---
...
*The core analytical tool of Private Equity.*
*Key courses: **Wharton FNCE 748, Columbia Value Investing, HBS PE electives***
...
**The math**: Buy for $500M using $350M debt + $150M equity. Sell for $700M in 5 years.
After repaying debt: equity value = $350M → **2.3× return on equity**

Without leverage: $500M → $700M = 1.4× return.
...
$$MOIC = \frac{\text{Exit Equity Value}}{\text{Entry Equity Value}}$$

$$IRR = \left(\frac{\text{Exit Equity Value}}{\text{Entry Equity Value}}\right)^{1/n} - 1$$
