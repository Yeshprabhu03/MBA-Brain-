...
**Bezos's logic**: "Any service Amazon builds and uses internally, we should offer externally."
→ This was not an accident — it was a deliberate strategy to extract value from infrastructure costs.
