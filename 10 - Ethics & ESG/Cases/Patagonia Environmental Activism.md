...
1. Authenticity is the most valuable brand asset in the ESG era
2. Purpose-driven companies can outperform by attracting top talent and high-LTV customers
3. Sustainability must be an 'Operational Reality' (Worn Wear), not just a marketing campaign
4. Founder exit strategy is the 'Ultimate Test' of mission fidelity—Chouinard chose Earth over an IPO

---

## 🎓 Discussion Questions

1. Could Patagonia's model work if the company was publicly traded? Why or why not?
2. Is 'Don't Buy This Jacket' a genius marketing trick or a sincere ethical statement?
3. How does Patagonia manage the 'hypocrisy' of being an apparel company (which is inherently polluting)?
